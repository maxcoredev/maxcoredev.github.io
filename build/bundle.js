...
var app = (function () {
    ...
    line-height: 33px;
    			...
    			add_location(p0, file, 2, 0, 17);
    			add_location(h20, file, 5, 0, 312);
    			add_location(p1, file, 7, 0, 327);
    			add_location(p2, file, 7, 292, 619);
    			add_location(p3, file, 8, 0, 624);
    			add_location(p4, file, 8, 96, 720);
    			add_location(code, file, 9, 5, 730);
    			add_location(pre, file, 9, 0, 725);
    			add_location(i0, file, 15, 3, 845);
    			add_location(p5, file, 15, 0, 842);
    			add_location(p6, file, 17, 0, 984);
    			if (img.src !== (img_src_value = "/images/nature.jpg")) attr_dev(img, "src", img_src_value);
    			set_style(img, "margin", "0 auto");
    			add_location(img, file, 20, 1, 1160);
    			set_style(div, "height", "250px");
    			set_style(div, "overflow", "hidden");
    			add_location(div, file, 19, 0, 1115);
    			add_location(h21, file, 23, 0, 1223);
    			add_location(p7, file, 25, 0, 1241);
    			add_location(i1, file, 26, 3, 1441);
    			add_location(p8, file, 26, 0, 1438);
    			add_location(h22, file, 28, 0, 1548);
    			attr_dev(a, "href", "https://bahamas10.github.io/ryb/");
    			add_location(a, file, 30, 109, 1674);
    			add_location(p9, file, 30, 0, 1565);
    			add_location(h23, file, 34, 0, 1808);
    			add_location(i2, file, 36, 27, 1851);
    			add_location(i3, file, 36, 60, 1884);
    			add_location(p10, file, 36, 0, 1824);
    			add_location(p11, file, 37, 0, 1964);
    			add_location(p12, file, 38, 0, 2169);
    			add_location(br, file, 40, 0, 2243);
    		},
...
const products = new List('product', {
  ...
  search: true
    ...
    /* src/Process.svelte generated by Svelte v3.24.1 */

    const file$5 = "src/Process.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h10 = element("h1");
    			h10.textContent = "repetit.ru";
    			t1 = space();
    			div0 = element("div");
    			img0 = element("img");
    			t2 = space();
    			h11 = element("h1");
    			h11.textContent = "omgdrop.com";
    			t4 = space();
    			h30 = element("h3");
    			...
    			div3 = element("div");
    			img3 = element("img");
    			add_location(h10, file$5, 5, 0, 218);
    			if (img0.src !== (img0_src_value = "/screens/r3.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "svelte-1hqei8m");
    			add_location(img0, file$5, 6, 5, 243);
    			attr_dev(div0, "class", "svelte-1hqei8m");
    			add_location(div0, file$5, 6, 0, 238);
    			add_location(h11, file$5, 7, 0, 277);
    			add_location(h30, file$5, 8, 0, 298);
    			if (img1.src !== (img1_src_value = "/screens/matematika.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-1hqei8m");
    			add_location(img1, file$5, 9, 5, 322);
    			attr_dev(div1, "class", "svelte-1hqei8m");
    			add_location(div1, file$5, 9, 0, 317);
    			add_location(h31, file$5, 10, 0, 364);
    			if (img2.src !== (img2_src_value = "/screens/items.png")) attr_dev(img2, "src", img2_src_value);
    			...
    			add_location(h32, file$5, 12, 0, 433);
    			if (img3.src !== (img3_src_value = "/screens/zakupka.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "class", "svelte-1hqei8m");
    			add_location(img3, file$5, 13, 5, 455);
    			attr_dev(div3, "class", "svelte-1hqei8m");
    			add_location(div3, file$5, 13, 0, 450);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			a3 = element("a");
    			a3.textContent = "Populate";
    			t7 = space();
    			a4 = element("a");
    			a4.textContent = "Select";
    			t9 = space();
    			a5 = element("a");
    			t10 = text("GitHub ");
    			t11 = space();
    			...
    			toggle_class(a1, "current", /*hash*/ ctx[1] === "#table");
    			add_location(a1, file$6, 71, 1, 2109);
    			attr_dev(a2, "class", "item svelte-7gtsyl");
    			attr_dev(a2, "href", "/#buttons");
    			toggle_class(a2, "current", /*hash*/ ctx[1] === "#buttons");
    			add_location(a2, file$6, 72, 1, 2213);
    			attr_dev(a3, "class", "item svelte-7gtsyl");
    			attr_dev(a3, "href", "/#populate");
    			toggle_class(a3, "current", /*hash*/ ctx[1] === "#populate");
    			add_location(a3, file$6, 73, 1, 2297);
    			attr_dev(a4, "class", "item svelte-7gtsyl");
    			attr_dev(a4, "href", "/#select");
    			toggle_class(a4, "current", /*hash*/ ctx[1] === "#select");
    			add_location(a4, file$6, 74, 1, 2384);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function route() {
    		...
    		if (hash === "") {
    			...
    			$$invalidate(0, component = Process);
    		}
    	}
